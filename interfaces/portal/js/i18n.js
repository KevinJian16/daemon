...
const D = {
  zh:{
    ...
    submitRating:'提交评价',
    appendSubmit:'提交追加评价',
    submitting:'提交中…',cancellingMsg:'取消中…',cancelOk:'已取消',
    ...
    attachTip:'添加附件',composeTip:'新建对话',
  ...
  en:{
    ...
    submitting:'Submitting…',cancellingMsg:'Cancelling…',cancelOk:'Cancelled',
    ...
    attachTip:'Attach file',composeTip:'New conversation',
