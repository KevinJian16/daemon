...
const D = {
  zh:{
    ...
    circuitHint:'Circuit 由对话页创建，这里可暂停/触发/删除。',
    goCompose:'去对话页创建',
  ...
  en:{
    ...
    send:'Send',pause:'Pause',resume:'Resume',redirect:'Redirect',cancel:'Cancel Run',
    ...
    circuitHint:'Circuits are created from Compose. You can pause/trigger/delete here.',
    goCompose:'Go to Compose',
