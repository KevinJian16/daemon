...
const D = {
  zh:{
    ...
    composeTitle:'需要做什么？',composeHint:'描述你的目标，系统自动判断为 Errand/Charge/Endeavor 并分配 agent。',
  ...
  en:{
    ...
    composeTitle:'What do you need?',composeHint:'Describe your objective. Daemon will classify Errand/Charge/Endeavor and assign agents.',
    planDetected:'Deed plan detected',submitPlan:'Submit',rewrite:'Rewrite',
    send:'Send',pause:'Pause',resume:'Resume',redirect:'Redirect',cancel:'Cancel Deed',
    passages:'Passage Progress',
    ...
    hideDeep:'Hide detailed feedback',attachTip:'Attach file',composeTip:'New deed',
    cancelConfirm:'Cancel this deed?',redirectPrompt:'New direction or instruction:',
  },
};
