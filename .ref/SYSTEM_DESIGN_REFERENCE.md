...
| Session 固定 overhead 上限 | ≤ 800 tokens | §3.3 | MEMORY.md + Mem0 + Step 指令 |
...
| DD-42 | 2026-03-14 | 客户端三 view：对话+浏览器+阅读器 | 覆盖所有用户场景，无需其他 UI | FINAL |
...
| DD-53 | 2026-03-14 | 桌面客户端改用 Electron（§4.2） | 浏览器 view 需 Chromium 兼容性，用户默认浏览器为 Chrome | FINAL |
...
| DD-64 | 2026-03-15 | 桌面客户端 3 显示模式：对话/场景面板/浏览器 | 对话是主要交互，面板提供场景概览，浏览器处理外部内容 | FINAL |
